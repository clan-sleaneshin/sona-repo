...
import { SworkerComponent } from 'app/entities/sworker/sworker.component';
import { SworkerService } from 'app/entities/sworker/sworker.service';
import { Sworker } from 'app/shared/model/sworker.model';

describe('Component Tests', () => {
  describe('Sworker Management Component', () => {
    let comp: SworkerComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SworkerComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.sworkers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
